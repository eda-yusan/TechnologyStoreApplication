...
namespace TeknolojiMagazasi
{
    public partial class KullaniciSatis : Form
    {
        ...
        private void dataGridViewSatis2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void KullaniciSatis_Load_1(object sender, EventArgs e)
        {
            SatisGetir();
        }
    }
