...
namespace TeknolojiMagazasi
{
    public partial class Urunler : Form
    {
        ...
        private void FillComboBoxOptions()
        {
            ...
            cmbSiralamaOptions.Items.Add("Stok Bilgisi Çoktan Aza");
        ...
        private void RefreshDataGridView()
        {
            ...
            string connectionString = "server=DESKTOP-7FBUO4Q\\SQLEXPRESS; Initial Catalog=dbTeknolojiMagaza; Integrated Security=SSPI";
        ...
        private void ImportDataToDatabase(string filePath)
        {
            try
            {
                ...
                using (StreamReader sr = new StreamReader(filePath))
                {
                    ...
                    using (SqlConnection connection = new SqlConnection("server=DESKTOP-7FBUO4Q\\SQLEXPRESS; Initial Catalog=dbTeknolojiMagaza; Integrated Security=SSPI"))
                    {
        ...
        private void txtStokGuncelle_TextChanged(object sender, EventArgs e)
        {
        ...
        private void cmbSiralamaOptions_SelectedIndexChanged_1(object sender, EventArgs e)
        {
