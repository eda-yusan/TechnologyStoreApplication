...
namespace TeknolojiMagazasi
{
    public partial class Kampanya : Form
    {
        ...
        void KampanyaGetir()
        {
            conn = new SqlConnection("server=DESKTOP-7FBUO4Q\\SQLEXPRESS; Initial Catalog=dbTeknolojiMagaza; Integrated Security=SSPI");
            conn.Open();
        ...
        private void btnKampanyaEkle_Click(object sender, EventArgs e)
        {
            try
            {
                using (conn = new SqlConnection("server=DESKTOP-7FBUO4Q\\SQLEXPRESS; Initial Catalog=dbTeknolojiMagaza; Integrated Security=SSPI"))
                {
        ...
        private void Kampanya_Load_1(object sender, EventArgs e)
        {
            KampanyaGetir();
        }
    }
