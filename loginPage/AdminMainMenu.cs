...
namespace loginPage
{
    ...
    public partial class AdminMenu : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            try
            {
                using (con = new SqlConnection("server=DESKTOP-7FBUO4Q\\SQLEXPRESS; Initial Catalog=dbTeknolojiMagaza; Integrated Security=SSPI"))
                {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            string raporKlasorYolu = "C:\\Rapor";
            if (!Directory.Exists(raporKlasorYolu))
            {
                Directory.CreateDirectory(raporKlasorYolu);
            }
            ...
            using (FileStream fs = new FileStream($"{raporKlasorYolu}\\{fileName}.pdf", FileMode.Create))
            {
        ...
        private void txtIsimSoyad_TextChanged(object sender, EventArgs e)
        {
